...
/*
Spring Security 5.7 이후부터는 @Bean으로 SecurityFilterChain을 구현해서 시큐리티를 적용시키는 방법을 권장
기본 필터체인 구성을 @Bean으로 등록시키도록 코드를 작성.
최초에는 WebSecurityCustomizer 코드를 통해 정정 자원에 대해서는 보안을 적용하지 않도록 코드를 설정.
*/
